...
import xs.rfid.repository.VerificationCodeRepository;
...
public class VerificationCodeServiceImpl implements VerificationCodeService {
    ...
    public EmailVo sendEmail(VerificationCode code) {
        ...
        if(verificationCode == null){
            ...
            emailVo = new EmailVo(Collections.singletonList(code.getValue()),"先施RFID系统",content);
        ...
        // 存在就再次发送原来的验证码
            ...
            emailVo = new EmailVo(Collections.singletonList(verificationCode.getValue()),"先施RFID系统",content);
        }
        return emailVo;
    }
