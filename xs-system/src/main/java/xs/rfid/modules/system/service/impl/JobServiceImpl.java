...
import xs.rfid.modules.system.repository.DeptRepository;
import xs.rfid.modules.system.service.dto.JobQueryCriteria;
...
import xs.rfid.modules.system.repository.JobRepository;
import xs.rfid.modules.system.service.JobService;
import xs.rfid.modules.system.service.dto.JobDto;
import xs.rfid.modules.system.service.mapper.JobMapper;
...
public class JobServiceImpl implements JobService {
    ...
    public void download(List<JobDto> jobDtos, HttpServletResponse response) throws IOException {
        ...
        for (JobDto jobDTO : jobDtos) {
            ...
            map.put("创建日期", DateUtil.format(jobDTO.getCreateTime(), "yyyy-MM-dd HH:mm:ss"));
            list.add(map);
        }
