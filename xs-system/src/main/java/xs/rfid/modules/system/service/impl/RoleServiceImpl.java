...
import xs.rfid.modules.system.repository.RoleRepository;
import xs.rfid.modules.system.service.RoleService;
import xs.rfid.modules.system.service.dto.RoleDto;
import xs.rfid.modules.system.service.dto.RoleQueryCriteria;
import xs.rfid.modules.system.service.dto.RoleSmallDto;
import xs.rfid.modules.system.service.dto.UserDto;
import xs.rfid.modules.system.service.mapper.RoleMapper;
import xs.rfid.modules.system.service.mapper.RoleSmallMapper;
...
public class RoleServiceImpl implements RoleService {
    ...
    public void download(List<RoleDto> roles, HttpServletResponse response) throws IOException {
        ...
        for (RoleDto role : roles) {
            ...
            map.put("创建日期", DateUtil.format(role.getCreateTime(), "yyyy-MM-dd HH:mm:ss"));
            list.add(map);
        }
