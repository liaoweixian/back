...
import xs.rfid.exception.EntityExistException;
import xs.rfid.exception.EntityNotFoundException;
import xs.rfid.modules.system.domain.UserAvatar;
import xs.rfid.modules.system.repository.UserAvatarRepository;
import xs.rfid.modules.system.repository.UserRepository;
import xs.rfid.modules.system.service.UserService;
import xs.rfid.modules.system.service.dto.RoleSmallDto;
import xs.rfid.modules.system.service.dto.UserDto;
import xs.rfid.modules.system.service.dto.UserQueryCriteria;
import xs.rfid.modules.system.service.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public void download(List<UserDto> queryAll, HttpServletResponse response) throws IOException {
        ...
        for (UserDto userDTO : queryAll) {
            ...
            map.put("最后修改密码的时间",
                    Optional.ofNullable(userDTO.getLastPasswordResetTime())
                            .map(e->{
                                return DateUtil.format(e, "yyyy-MM-dd HH:mm:ss");
                             })
                            .orElse("") );
            map.put("创建日期", DateUtil.format(userDTO.getCreateTime(), "yyyy-MM-dd HH:mm:ss"));
            list.add(map);
        }
