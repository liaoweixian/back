...
import xs.rfid.modules.system.service.dto.DeptQueryCriteria;
...
import xs.rfid.modules.system.service.mapper.DeptMapper;
...
public class DeptServiceImpl implements DeptService {
    ...
    public void download(List<DeptDto> deptDtos, HttpServletResponse response) throws IOException {
        ...
        for (DeptDto deptDTO : deptDtos) {
            ...
            map.put("创建日期", DateUtil.format(deptDTO.getCreateTime(), "yyyy-MM-dd HH:mm:ss"));
            list.add(map);
        }
